...
function EditarRdo() {
  ...
  if (isError && error instanceof RdoNaoEncontradoError) {
    return <RdoNaoEncontrado />;
  }
  if (isError) {
    return (
  ...
  if (!data) return null;
  return <FormularioRdo modo="editar" obra={data.obra} rdo={data.rdo} />;
}

function RdoNaoEncontrado() {
  return (
